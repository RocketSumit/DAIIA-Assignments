    		...
    		loop neighbour over: neighbours {
				ask neighbour {
					if !self.bad and self.targetPoint = nil and !(self.hungry or self.thirsty) {
						...
						if float(myself.random_point[0]) > worldDimension {
							myself.random_point[0] <- worldDimension;
						}
						if float(myself.random_point[1]) > worldDimension {
							myself.random_point[1] <- worldDimension;
						}
						if float(myself.random_point[0]) < 0.0 {
							myself.random_point[0] <- 0.0;
						}
						if float(myself.random_point[1]) < 0.0 {
							myself.random_point[1] <- 0.0;
						}
